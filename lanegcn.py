...
def get_config(args):
    ...
    """Dataset"""
    # Raw Dataset
    config["train_split"] = os.path.join(root_path, "data/train/data")
    config["val_split"] = os.path.join(root_path, "data/val/data")
    config["test_split"] = os.path.join(root_path, "data/test_obs/data")
